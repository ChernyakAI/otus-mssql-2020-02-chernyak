...
/*
exec sp_helpindex N'Sales.Orders';
exec sp_helpindex N'Sales.OrderLines';

exec sp_helpindex N'Sales.Invoices';

exec sp_helpindex N'Warehouse.StockItems';
exec sp_helpindex N'Warehouse.StockItemTransactions';
